"""
U-Net for Wildfire Spread Prediction - 16 Channels
Supervised learning approach with direct pixel-level supervision

Input: 17 channels (16 environment + 1 current fire mask)
Output: 1 channel (probability of burning in next timestep)
"""
import torch
...
class UNet(nn.Module):
    ...
    - Output: (B, 1, 30, 30) - probability of burning
    """

    def __init__(self, n_channels=17, n_classes=1, bilinear=False):
