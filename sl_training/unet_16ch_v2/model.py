"""
U-Net for Wildfire Spread Prediction - V2 with Multi-Timestep + Focal Loss

Improvements:
1. Multi-timestep prediction (t+1, t+2, t+3)
2. Focal loss for handling class imbalance and hard examples
