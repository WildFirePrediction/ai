"""
A3C Training Script V3 LSTM - 16 Channels (FULL FEATURES)
DEM + All Weather + NDVI + FSM with LSTM temporal context
Data augmentation + strict penalties for non-movement
"""
import os
...
from a3c_16ch.V3_LSTM.worker import worker_process_lstm
...
def main():
    parser = argparse.ArgumentParser(description='A3C V3 LSTM Training - 16 Channels (FULL)')
    ...
    print(f"A3C V3 LSTM Training - 16 Channels (FULL FEATURES)")
    print(f"=" * 70)
