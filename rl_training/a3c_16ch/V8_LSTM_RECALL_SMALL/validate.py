"""
Validation Script for A3C V8 SMALL LSTM RECALL - RECALL-FIRST SUPERAGGRO - 16 Channels with Relaxed IoU
...
def main():
    parser = argparse.ArgumentParser(description='A3C V8 SMALL LSTM RECALL - RECALL-FIRST SUPERAGGRO Validation - Relaxed IoU')
    ...
    print(f"A3C V8 SMALL LSTM RECALL - RECALL-FIRST SUPERAGGRO Validation - Relaxed IoU (8-neighbor tolerance)")
    print(f"=" * 70)
    ...
    print(f"\n" + "=" * 70)
    print(f"VALIDATION RESULTS (16ch LSTM SMALL - RELAXED IoU)")
    print(f"=" * 70)
