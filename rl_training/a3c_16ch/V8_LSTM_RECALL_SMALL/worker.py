"""
A3C Worker V8 SMALL LSTM RECALL - RECALL-FIRST SUPERAGGRO REWARD SHAPING
16 Channels with RELAXED IoU (8-neighbor tolerance) + RECALL-OPTIMIZED reward system
SMALLER MODEL: 3.5x smaller than V6
...
def worker_process_lstm(worker_id, shared_model, optimizer, filtered_episodes, config,
    ...
    """
    Worker process for A3C V8 SMALL LSTM with RECALL-FIRST SUPERAGGRO reward shaping.
