"""
Full RL multi-point demo pipeline orchestrator
Generates multi-point dummy fire -> Runs RL inference -> Creates visualization
"""
import subprocess
import sys
...
def run_full_rl_multi_demo(num_fires=1, device='cuda'):
    """
    Run complete RL multi-point demo pipeline
    ...
    print("="*70)
    print("RL MULTI-POINT DEMO PIPELINE")
    print("="*70)
    ...
    for i in range(num_fires):
        ...
        # Step 2: Run RL inference
        print("\nStep 2/3: Running RL inference with multi-point initialization...")
        ...
        print(f"✓ RL inference complete: {prediction_json}")
    ...
    # Final summary
    print(f"\n{'='*70}")
    print("RL MULTI-POINT DEMO PIPELINE COMPLETE")
    print(f"{'='*70}")
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='RL Multi-Point Full Demo Pipeline')
    ...
    results = run_full_rl_multi_demo(
